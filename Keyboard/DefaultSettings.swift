    ...
    func addConstraints() {
        ...
        if hasLongText {
            ...
            let left = NSLayoutConstraint(
                item: longLabel, attribute: .left, relatedBy: .equal, toItem: self, attribute: .left, multiplier: 1, constant: sideMargin
            )
            
            let right = NSLayoutConstraint(
                item: longLabel, attribute: .right, relatedBy: .equal, toItem: self, attribute: .right, multiplier: 1, constant: -sideMargin
            )
            
            let top = NSLayoutConstraint(
                item: longLabel, attribute: .top, relatedBy: .equal, toItem: sw, attribute: .bottom, multiplier: 1, constant: margin
            )
